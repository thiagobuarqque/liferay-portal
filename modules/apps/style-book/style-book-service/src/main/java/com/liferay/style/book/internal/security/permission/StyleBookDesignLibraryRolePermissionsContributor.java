 ...
 */
@Component(service = DesignLibraryRolePermissionsContributor.class)
public class StyleBookDesignLibraryRolePermissionsContributor
	implements DesignLibraryRolePermissionsContributor {

	@Override
	public List<DesignLibraryRolePermission> getDesignLibraryRolePermissions() {
		return List.of(
			new DesignLibraryRolePermission(
