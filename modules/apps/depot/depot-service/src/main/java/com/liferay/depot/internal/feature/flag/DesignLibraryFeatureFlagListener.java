...
public class DesignLibraryFeatureFlagListener implements FeatureFlagListener {
	...
	public void onValue(
		...
		try (SafeCloseable safeCloseable =
			...
			depotDesignLibraryRolesHelper.grantContributedPermissions(
				companyId, _designLibraryRolePermissionsContributors);
		}
	...
	private volatile List<DesignLibraryRolePermissionsContributor>
		_designLibraryRolePermissionsContributors;
